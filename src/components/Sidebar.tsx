...
export const Sidebar = () => {
    ...
    return (
        <aside className="flex flex-col items-center justify-between p-4 h-screen sticky top-0 gap-4">
            ...
            <div className="bg-sidebar border-2 border-sidebar-border rounded-full flex flex-col items-center py-6 px-3 shadow-lg">
                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                to={item.path}
                                title={item.label}
                                className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200 ${isActive
